...
public class ConfigureSystem {
    ...
    CommunityAdminNew comAd;
    SystemAdminNew sysAd;
    HospitalAdminNew hospAd;
    ...
    public void setEnch1(Encounter ench1) {
        this.ench1 = ench1;
    }

    public Encounter getEnch2() {
        return ench2;
    }

    public void setEnch2(Encounter ench2) {
        this.ench2 = ench2;
    }
    ...
    public ArrayList<Encounter> getEncHList() {
        return encHList;
    }

    public void setEncHList(ArrayList<Encounter> encHList) {
        this.encHList = encHList;
    }

    public EncounterHistory getEncH() {
        return encH;
    }

    public void setEncH(EncounterHistory encH) {
        this.encH = encH;
    }

    public CommunityAdminNew getComAd() {
        return comAd;
    }

    public void setComAd(CommunityAdminNew comAd) {
        this.comAd = comAd;
    }

    public SystemAdminNew getSysAd() {
        return sysAd;
    }

    public void setSysAd(SystemAdminNew sysAd) {
        this.sysAd = sysAd;
    }

    public HospitalAdminNew getHospAd() {
        return hospAd;
    }

    public void setHospAd(HospitalAdminNew hospAd) {
        this.hospAd = hospAd;
    }
...
//        communityMasterList.add(c5);
    ...
    public boolean verifyDoctorCred(ArrayList<Doctor> doc,String username,String password){
        boolean flag = false;
    ...
    public boolean verifyHospCred(HospitalAdminNew hosAd,String username,String password){
        boolean flag = false;
